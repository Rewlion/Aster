...
# define SHTOKENTYPE
  enum shtokentype
  {
    ...
    TFX_TOKEN_ROBUFFER = 417,      /* "Buffer"  */
    TFX_TOKEN_RWSTRUCTUREDBUFFER = 418, /* "RWStructuredBuffer"  */
    TFX_TOKEN_RWBUFFER = 419,      /* "RWBuffer"  */
    TFX_TOKEN_TEXTURE2D = 420,     /* "Texture2D"  */
    TFX_TOKEN_TEXTURE3D = 421,     /* "Texture3D"  */
    TFX_TOKEN_TEXTURE_CUBE = 422,  /* "TextureCube"  */
    TFX_TOKEN_RWTEXTURE3D = 423    /* "RWTexture3D"  */
  };
