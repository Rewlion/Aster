...
namespace gapi
{
  ...
  class CmdEncoder
  {
    public:
      ...
      virtual
      void fillBuffer(const BufferHandler buffer, const uint32_t offset, const uint32_t size, const uint32_t data) = 0;
      ...
      virtual
      void dispatchIndirect(const BufferHandler, size_t offset = 0) = 0;
