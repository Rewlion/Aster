...
namespace gapi
{
  ...
  void*                    (*gapi_map_buffer)(const BufferHandler buffer, const int flags);
  ...
  auto map_buffer(BufferHandler buffer, const int flags) -> void*
  {
    return gapi_map_buffer(buffer, flags);
  }
