...
void mk_fg_node_gibs_resources(Event*, ComponentsAccessor&)
{
  ...
  { 
    ...
    return [gibs_dbg_alloc,gibs_surfels_lifetime,gibs_surfels_storage,gibs_surfels_pool,gibs_surfels_allocation_locks,gibs_surfels_spatial_storage,gibs_surfels_meta,gibs_surfels_coverage](gapi::CmdEncoder& encoder)
    {
      gibs_resources_init(encoder, gibs_dbg_alloc.get(), gibs_surfels_lifetime.get(), gibs_surfels_storage.get(), gibs_surfels_pool.get(), gibs_surfels_allocation_locks.get(), gibs_surfels_spatial_storage.get(), gibs_surfels_meta.get(), gibs_surfels_coverage.get());
    };
  });
}
...
void mk_fg_node_gibs_surfels_coverage(Event*, ComponentsAccessor&)
{
  ...
  { 
    ...
    return [gbuffer_depth,surfelsCoverage,surfelsStorage,surfelsSpatialStorage,render_size](gapi::CmdEncoder& encoder)
    {
...
void mk_fg_node_gibs_allocate_surfels(Event*, ComponentsAccessor&)
{
  ...
  { 
    ...
    return [dbgTex,gbuffer_normal,gbuffer_depth,surfelsLifeTime,surfelsStorage,surfelsPool,surfelsAllocLocks,surfelsMeta,surfelsCoverage,render_size](gapi::CmdEncoder& encoder)
    {
