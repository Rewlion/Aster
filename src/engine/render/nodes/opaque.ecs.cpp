...
ECS_EVENT_SYSTEM()
static
void mk_gbuffer_main_pass_node(const Engine::OnFrameGraphInit&)
{
...
// ECS_EVENT_SYSTEM()
// static
// void mk_early_transparent_sync_node(const Engine::OnFrameGraphInit&)
//   {
//     fg::register_node("early_transparent_sync", FG_FILE_DECL, [](fg::Registry& reg)
//     {
...
ECS_EVENT_SYSTEM()
static
void mk_transparent_sync_node( const Engine::OnFrameGraphInit&)
  {
    fg::register_node("transparent_sync", FG_FILE_DECL, [](fg::Registry& reg)
    {
      reg.renameTexture("resolve_target", "transparent_target", gapi::TextureState::RenderTarget);
      return [](gapi::CmdEncoder& encoder) {};
    });
  }
