...
NODE_BEGIN(gibs_indirect_light)
  ORDER_ME_BEFORE(gibs_sync_out)
  ...
  CREATE_TEX_2D(indirect_light, TEX_SIZE_RELATIVE(), R32G32B32A32_S, TEX_USAGE2(UAV,SRV), TEX_STATE(ShaderReadWrite))

  BIND_SHADER_VAR_AS   (indirect_light, gibsIndirectLight)
